...
const User = () => {
  ...
  const handleAddUser = (newUser) => {
    ...
    const qrCode = generateQRCode(`Name: ${newUser.name} Grade: ${newUser.gradeLevel} Section: ${newUser.section} Student No: ${newUser.studentNumber} Contact No: ${newUser.contactNumber}`);
